...
\begin{document}
  ...
  \subsection{Trajectory Stabilizability}
    ...
    An asymptotically orbitally stabilizing feedback can be constructed using the transverse linearization approach~\cite{Banaszuk-1995,Surov-2020}, wherein the dynamics~(\ref{eq:pvtol-dynamics}) are expressed in new local coordinates
    ...
    The conducted numerical analysis demonstrated the controllability of the LTV system, and hence confirmed the existence of a periodic stabilizing solution to the LQR problem. The stability of the nonlinear closed-loop system was verified through computer simulations, the results of which are presented in the following video:~\url{https://youtube.com/shorts/EM2qfht1D74}.
  ...
  \label{sec:non-regular-vhc}
    ...
    can move along the direction $\phi'\left(\theta_{s}\right)$ (under additional requirements), but
